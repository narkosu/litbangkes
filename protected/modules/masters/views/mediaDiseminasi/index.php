...
<div style="text-align:right">
    <a class="btn" href="<?php echo Yii::app()->createUrl('masters/mediadiseminas/create')?>">Tambah Baru</a>
</div>
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                      <td class="aligncenter"><?php echo $no?>.</td>
                        ...
                        <td class="center">
                            <a href="<?php echo Yii::app()->createUrl('/masters/mediadiseminasi/update/id/'.$row->id)?>"  class="btn btn-warning">Edit</a> 
