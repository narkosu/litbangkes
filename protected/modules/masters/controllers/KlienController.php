...
class KlienController extends Controller
{
  ...
  /**
    ...
    $return = array();
		$details = DetailKlien::model()->findAll('klien_id = '.$id);
    if ( !empty($details) ){
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Klien']))
		{
			$model->attributes=$_POST['Klien'];
			if($model->save())
	...
	{
		$model=new Klien('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Klien']))
			$model->attributes=$_GET['Klien'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='klien-form')
		{
