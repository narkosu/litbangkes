...
class StrukturorganisasiController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','Listunitkerja'),
				'users'=>array('@'),
			),
    ...
    */  
	...
	public function actionListunitkerja(){
		$data = Unitkerja::model()->findAll('deputi_id=:dputid', 
		array(':dputid'=>(int) $_POST['deputi_id']));
		
		$data=CHtml::listData($data,'id','unitkerja_name');
		
		echo "<option value=''>Unit Kerja</option>";
